 ...
 */
/** Spend-by-key is an activity view, not a key inventory — only keys with
 * usage in the window appear here. The full key list (including unused keys)
 * lives in /setup's virtual key management section. */
